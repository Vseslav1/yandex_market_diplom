...
class ProductLocator:
    ...
    ADD_COMPARE = (By.XPATH, '//span[@class="_3bihM _2SUA6 _3kbFf IFARr _1A5yJ"]')

    FAVORITES = (By.CSS_SELECTOR, '[data-autotest-id="wishlist"]')
    PRODUCT_IN_FAVORITES = (By.CSS_SELECTOR, '[data-zone-name="productSnippet"]')

    SHARE = (By.CSS_SELECTOR, '[data-zone-name="shortUrl"]')

    BUY_NOW = (By.CSS_SELECTOR, '[data-auto="default-offer-buy-now-button"]')

    MORE_PRICES = (By.CSS_SELECTOR, '[data-baobab-name="morePrices"]')
